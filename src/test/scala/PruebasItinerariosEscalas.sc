...
object WorksheetDePruebas {
  ...
  def probarRuta(origen: String, destino: String, descripcion: String): (List[Itinerario], List[Itinerario]) = {
    ...
    val resultadoSecuencial = Try(itinerariosEscalas(vuelos, aeropuertos)(origen, destino))
    val resultadoParalelo = Try(itinerariosEscalasPar(vuelos, aeropuertos)(origen, destino))
